...
window.bgpic("space_invader_background.gif")

# Register the shape
turtle.register_shape("invader_Space_invader.gif")
turtle.register_shape("player_space_invader.gif")
...
player.shape("player_space_invader.gif")
player.penup()
player.speed(0)
...
for enemy in enemies:
    # enemy.color("Red")
    enemy.shape("invader_Space_invader.gif")
    enemy.penup()
    enemy.speed(0)
